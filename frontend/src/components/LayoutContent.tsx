...
export default function LayoutContent({ children }: { children: React.ReactNode }) {
  ...
  // 로딩 중: 공개 페이지는 즉시 렌더, 비공개는 Navbar + loading.tsx 스켈레톤 표시
  if (loading) {
    ...
    return (
      <div className="min-h-screen bg-gray-950 flex items-center justify-center px-6">
        <div className="text-center max-w-sm">
          <div className="mb-6">
            <svg className="w-8 h-8 mx-auto text-yellow-500 animate-[spin_8s_linear_infinite]" viewBox="0 0 24 24" fill="none">
              <path
