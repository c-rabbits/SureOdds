      ...
      <div className="rounded-lg border border-gray-800 bg-gray-900/80 p-3 hover:border-gray-600 hover:bg-gray-900 transition-all overflow-hidden">
        ...
        <div className="flex items-center justify-between gap-2 mb-2">
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            ...
            <span className="text-xs text-gray-600 whitespace-nowrap">{formatShortTime(match.start_time)}</span>
          </div>
        </div>
        ...
        {p ? (
          <>
            ...
            {/* 예상 골 + 신뢰도 */}
            <div className="flex items-center justify-between text-xs gap-2 mt-1.5">
          ...
          <div className="text-xs text-gray-600 text-center py-2 bg-gray-800/30 rounded">
            예측 데이터 준비 중...
          </div>
        )}
      </div>
